...
Page({
  ...
  getCenterLocation: function () {
    ...
    mapCtx.getCenterLocation({
      success: function (res) {
        ...
        that.getNearbyMarkers(res.latitude, res.longitude);
        that.regeocodingAddress();
  ...
  chooseAddress: function () {
    ...
    var city=null;
    var street=null;
    if (that.data.centerAddressBean!=null)
    {
      city=that.data.centerAddressBean.address_component.city ;
      street=that.data.centerAddressBean.address_component.street;
    }
    wx.navigateTo({
      url: '../chooseAddress/chooseAddress?city=' + city+ '&street=' +street ,
    })
  },
  ...
  getNearbyMarkers: function (curLatitude, curLongitude)
  {
    var that = this;
    //获取周围范围的坐标
    wx.request({
      url: 'http://localhost:51312/home/index?lat=' + curLatitude + '&lng=' + curLongitude,
      dataType: JSON,
      method: 'GET',
      success: function (res) {
        var marker = [];
